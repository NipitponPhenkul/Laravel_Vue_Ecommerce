            ...
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell @click="sortProducts" class="border-b-2 p-2 text-left" field="updated_at" :sort-field="sortField" :sort-direction="sortDirection">Last Update At</TableHeaderCell>
